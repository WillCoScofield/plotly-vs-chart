...
@Component({
  selector: 'app-chart-radar-chart',
  templateUrl: './chart-radar-chart.component.html',
  styleUrls: ['./chart-radar-chart.component.scss']
})
export class ChartRadarChartComponent implements OnInit {
